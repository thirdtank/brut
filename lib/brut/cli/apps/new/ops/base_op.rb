class Brut::CLI::Apps::New::Ops::BaseOp
  @dry_run = false

  def self.dry_run=(value)
    Brut::CLI::Apps::New::Ops::BaseOp.instance_variable_set(:@dry_run, value)
  end

  def self.dry_run? = !!Brut::CLI::Apps::New::Ops::BaseOp.instance_variable_get(:@dry_run)
