...
class Brut::CLI::Apps::New::Segments::BareBones < Brut::CLI::Apps::New::Base

  def self.friendly_name = "Bare bones framing"
  def self.segment_name = "bare_bones_app"
...
TRIGGER_EXCEPTION_KEY=dev-trigger-exception
  ...
  class InsertCustomElement < Brut::CLI::Apps::New::Ops::BaseOp
  ...
  class InsertEndToEndTestCode < Brut::CLI::Apps::New::Ops::PrismParsingOp
